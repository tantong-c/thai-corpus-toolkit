...
# ============================================================
THAI_STOP_WORDS = set([
    "ผม", "ฉัน", "เรา", "เขา", "เธอ", "มัน", "คุณ", "ท่าน", "พวกเขา",
    "ตัวเอง", "ตน", "ตนเอง", "ใคร", "อะไร", "ที่ไหน", "อย่างไร",
    "และ", "หรือ", "แต่", "เพราะ", "ถ้า", "แม้", "ทั้ง", "จน", "เมื่อ",
    "ก็", "ด้วย", "จึง", "ดังนั้น", "แล้ว", "จาก", "โดย", "ใน", "ที่", "ของ",
    "กับ", "ต่อ", "ผ่าน", "ตาม", "ระหว่าง", "ใต้", "บน", "นอก", "ใกล้",
    "ได้", "จะ", "คง", "น่า", "ควร", "ต้อง", "อาจ", "ยัง", "กำลัง", "เคย", "เพิ่ง",
    "ไม่", "ไม่ได้", "ไม่ต้อง", "ก็ได้", "มาก", "น้อย", "หลาย", "บาง", "ทั้งหมด",
    "ทุก", "แต่ละ", "ส่วนใหญ่", "ครับ", "ค่ะ", "นะ", "นะครับ", "นะคะ", "เลย",
    "หน่อย", "สิ", "ซิ", "ล่ะ", "เถอะ", "นี้", "นั้น", "โน้น", "ที่นี้", "ที่นั่น",
    "เร็ว", "ช้า", "ดี", "แย่", "ใหม่", "เก่า", "เป็น", "มี", "ไป", "มา",
    "ให้", "อยู่", "ว่า", "ซึ่ง", "อัน", "เอง", "ทำ", "ทาง", "คือ", "แบบ", "อย่าง",
])
...
def get_content_words(tokens, extra_stopwords=None):
    stop = THAI_STOP_WORDS | ENGLISH_STOP_WORDS
    if extra_stopwords:
